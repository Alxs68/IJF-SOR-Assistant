...
*   **Métricas del Grafo:** Expone en tiempo real el conteo dinámico de KUNs, aristas (relaciones), conectividad promedio y la lista de nodos hubs centrales calculados en vivo sobre la base de datos de origen.
