...
```json
{
  ...
  "vigencia_desde": "2026-01-01",
  "vigencia_hasta": "null",
  "contenido_original": "Breaking the grip of the opponent with two hands without an immediate attack is penalized with Shido.",
  "contenido_traduccion": "Romper el agarre del oponente utilizando dos manos sin realizar un ataque inmediato se penaliza con Shido.",
  "interpretacion": "Regula la combatividad prohibiendo romper agarres de forma meramente defensiva. El atleta debe mantener una intención ofensiva; romper el agarre sin proponer un ataque consecutivo resulta en amonestación.",
  "fuente_origen": "PAG-002",
  "referencia_especifica": "rules.ijf.org/gripping/breaking",
  "tags": [
    "shido",
    "kumikata",
    "grip-breaking"
